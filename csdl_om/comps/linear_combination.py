...
from csdl_om.utils.process_options import name_types, get_names_list, shape_types, get_shapes_list, scalar_types, get_scalars_list


class LinearCombination(ExplicitComponent):
    def initialize(self):

...
def test_sum_single_vector():
    ...
    np.testing.assert_almost_equal(example.sim['single_vector_sum'],
                                   desired_vector_sum)
...
def test_sum_single_matrix():
    ...
    np.testing.assert_almost_equal(example.sim['single_matrix_sum'],
                                   desired_matrix_sum)
...
def test_sum_single_tensor():
    ...
    np.testing.assert_almost_equal(example.sim['single_tensor_sum'],
                                   desired_tensor_sum)
...
def test_sum_multiple_vector():
    ...
    np.testing.assert_almost_equal(example.sim['multiple_vector_sum'],
                                   desired_vector_sum)
...
def test_sum_multiple_matrix():
    ...
    np.testing.assert_almost_equal(example.sim['multiple_matrix_sum'],
                                   desired_matrix_sum)
...
def test_sum_multiple_tensor():
    ...
    np.testing.assert_almost_equal(example.sim['multiple_tensor_sum'],
                                   desired_tensor_sum)
...
def test_sum_single_matrix_along0():
    ...
    np.testing.assert_almost_equal(example.sim['single_matrix_sum_along_0'],
...
def test_sum_single_matrix_along1():
    ...
    np.testing.assert_almost_equal(example.sim['single_matrix_sum_along_1'],
...
def test_sum_multiple_matrix_along0():
    ...
    np.testing.assert_almost_equal(example.sim['multiple_matrix_sum_along_0'],
...
def test_sum_multiple_matrix_along1():
    ...
    np.testing.assert_almost_equal(example.sim['multiple_matrix_sum_along_1'],

...
def test_vector_vector_inner():
    ...
    np.testing.assert_almost_equal(example.sim['VecVecInner'], desired_output)
...
def test_tensor_vector_inner():
    ...
    np.testing.assert_almost_equal(example.sim['TenVecInner'], desired_output)
...
def test_tensor_tensor_inner():
    ...
    np.testing.assert_almost_equal(example.sim['TenTenInner'], desired_output)

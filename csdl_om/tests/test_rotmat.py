...
def test_rotmat_scalar_rotX():
    ...
    np.testing.assert_almost_equal(example.sim['scalar_Rot_x'],
                                   desired_outputx)
...
def test_rotmat_scalar_rotY():
    ...
    np.testing.assert_almost_equal(example.sim['scalar_Rot_y'],
                                   desired_outputy)
...
def test_rotmat_same_radian_tensor_rotX():
    ...
    np.testing.assert_almost_equal(example.sim['tensor_Rot_x'], desired_output)
